...
<style>
    ...
    .sidebar {
        ...
        background-color: #9b5e1a; /* Color de fondo de la barra lateral */
    ...
    .sidebar .nav-link.active {
        background-color: #5d657a ; /* Color de fondo del enlace activo */
    }
    .sidebar .nav-link i {
        margin-right: 10px;
    }
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md shadow-sm bg bg-dark">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('rooms.index') }}">
                                <i class="fas fa-house"></i> <span>Cabañas</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('rooms.create') }}">
                                <i class="fas fa-house-medical"></i> <span>Agregar Cabaña</span>
                            </a>
                        </li>
                        <li class="nav-item">
